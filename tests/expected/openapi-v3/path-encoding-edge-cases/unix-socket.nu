# Auto-generated client for Path Encoding Edge Cases v1.0.0
# Source: <spec>
# Auth: --token flag or $env.PATH_ENCODING_EDGE_CASES_TOKEN
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "lines get" } } | get name | first)
...
export def "metadata get-metadata" [
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
  --insecure(-k) # Skip TLS verification
