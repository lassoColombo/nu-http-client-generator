# Auto-generated client for pandora v1.18.0-q1779717693
# Source: <spec>
# Auth: --token flag or $env.PANDORA_TOKEN

const BASE_URL = "https://quality-pandora.k8s.elmec.ad"

# Build auth: returns {scheme: string, headers: record, query: string, location: string}.
# `location` is "header" | "query" | "cookie" | "none" and tells dry-run callers
# where the token went without inspecting headers/query themselves.
def build-auth [token?: string, auth_scheme?: string]: nothing -> record {
  let token_val = if ($token != null) and ($token | is-not-empty) { $token } else { $env | get -o PANDORA_TOKEN | default "" }
...
def base-url-completer [] { ["https://quality-pandora.k8s.elmec.ad"] }
...
export def commands []: nothing -> table {
  ...
  let mod_name = (scope modules | where { $in.commands | any { $in.name == "idrs-analysis-filename create" } } | get name | first)
...
# POST /api/v1/idrs/{idrs}/analysis/filename/
#
# operationId: v1_idrs_analysis_filename_create
export def "idrs-analysis-filename create" [
  idrs: string
...
# POST /api/v1/idrs/{idrs}/analysis/sha256/
#
# operationId: v1_idrs_analysis_sha256_create
export def "idrs-analysis-sha256 create" [
  idrs: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# POST /api/v1/idrs/{idrs}/analysis/url/{url}/
#
# operationId: v1_idrs_analysis_url_create
export def "idrs-analysis-url create" [
  idrs: string
  url: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
...
# GET /api/v1/idrs/{idrs}/tasks/list/
#
# operationId: v1_idrs_tasks_list_retrieve
export def "idrs-tasks-list get" [
  idrs: string
  --base-url(-b): string@base-url-completer # API base URL
  --token(-t): string # Auth token
  --auth-scheme(-a): string@auth-scheme-completer # Auth scheme
...
# GET /api/v1/idrs/{idrs}/tasks/report/{id}/full/
#
...
# GET /api/v1/idrs/{idrs}/tasks/report/{id}/summary/
#
...
# GET /api/v1/idrs/{idrs}/tasks/status/{id}/
#
