...
export def "avcfg-asset-enable patch" [
  ...
  --hostname: string
  --last-seen: string
  --health-status: string@health-status-completer
  --active-av: string
  --person-name: string
  --via-login: string
  --atlantis-id: string
...
export def "avcfg-cynet-alerts-list list" [
  ...
  --incident-name: string
  --last-seen: string
  --last-seen-gte: string
  --last-seen-lte: string
  --notified-cardinalis: oneof<nothing, bool>
  --notified-llama: oneof<nothing, bool>
  --ordering: string
  --page: int
...
export def "avcfg-cynet-endpoints list" [
  ...
  --allow-errors(-e) # Return full response without error handling
  --dry-run(-n) # Return the request that would be sent without executing it
  --cynet-info-last-seen-at-gte: string
  --cynet-info-last-seen-at-lte: string
  --hostname: string
  --ordering: string
  --page: int
  --per-page: int
...
export def "avcfg-cynet-tenant update" [
  ...
  --note: string
  --alert: oneof<nothing, bool>
  --discovery: oneof<nothing, bool>
  cynet_info: record
