# Auto-generated client for Collection Format Edge Cases v2 v1.0.0
# Source: <spec>
# Auth: --token flag or $env.COLLECTION_FORMAT_EDGE_CASES_V2_TOKEN
...
def base-url-completer [] { ["https://api.example.com/v2"] }
...
export def "search list" [
  ...
  --csv-tags: list<string>
  --ssv-tags: list<string>
  --tsv-tags: list<string>
  --pipes-tags: list<string>
  --multi-tags: list<string>
  --x-accept-langs: list<string>
]: nothing -> any {
  ...
  do-request "get" $full_url $auth $insecure $raw $dry_run $max_time $allow_errors $full "application/json" null {query: ({"csvTags": $csv_tags, "ssvTags": $ssv_tags, "tsvTags": $tsv_tags, "pipesTags": $pipes_tags, "multiTags": $multi_tags} | compact), body: null}
}
