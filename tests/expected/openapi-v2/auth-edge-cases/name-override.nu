...
export def "and-header get" [
  ...
  let auth = (merge-auth [(build-auth ($token_apikeyheader | default ($env | get -o TEST_CLIENT_APIKEYHEADER_TOKEN | default "")) "x-api-key") (build-auth ($token_clientidheader | default ($env | get -o TEST_CLIENT_CLIENTIDHEADER_TOKEN | default "")) "x-client-id")])
  let base = ($base_url | default $BASE_URL)
