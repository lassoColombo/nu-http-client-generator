...
export def "query media" [
  ...
  --id-mal-in: int
  --id-mal-not-in: int
  --start-date-greater: string
  --start-date-lesser: string
  --start-date-like: string
  --end-date-greater: string
  --end-date-lesser: string
  --end-date-like: string
  --format-in: string@format-in-completer
  --format-not: string@format-not-completer
  --format-not-in: string@format-not-in-completer
  --status-in: string@status-in-completer
  --status-not: string@status-not-completer
  --status-not-in: string@status-not-in-completer
  --episodes-greater: int
  --episodes-lesser: int
  --duration-greater: int
  --duration-lesser: int
  --chapters-greater: int
  --chapters-lesser: int
  --volumes-greater: int
  --volumes-lesser: int
  --genre-in: string
  ...
  --tag-in: string
  --tag-not-in: string
  --tag-category-in: string
  --tag-category-not-in: string
  --licensed-by-in: string
  --licensed-by-id-in: int
  --average-score-not: int
  --average-score-greater: int
  --average-score-lesser: int
  --popularity-not: int
  --popularity-greater: int
  --popularity-lesser: int
  --source-in: string@source-in-completer
...
export def "query airing-schedule" [
  ...
  --episode-greater: int
  --episode-lesser: int
  --airing-at-greater: int
  --airing-at-lesser: int
...
export def "query media-list" [
  ...
  --status-not: string@status-not-completer-1
  --media-id-in: int
  --media-id-not-in: int
  --notes-like: string
  --started-at-greater: string
  --started-at-lesser: string
  --started-at-like: string
  --completed-at-greater: string
  --completed-at-lesser: string
  --completed-at-like: string
...
export def "mutation update-user" [
  ...
  --donator-badge: string
  --notification-options: record
  --timezone: string
...
export def "mutation save-media-list-entry" [
  ...
  --started-at-year: int
  --started-at-month: int
  --started-at-day: int
  --completed-at-year: int
  --completed-at-month: int
  --completed-at-day: int
]: any -> record {
  let input = $in
  let auth = (build-auth $token ($auth_scheme | default $DEFAULT_AUTH))
  let base = ($base_url | default $BASE_URL)
